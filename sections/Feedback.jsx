...
const Feedback = () => (
  <section className={`sm:py-[4.5rem] py-6 sm:px-16 px-6 z-10 relative `}>
   ...
   variants={fadeIn('right', 'tween', 0.2, 1)}
        initial={fadeIn('right', 'tween', 0.2, 1).hidden}
        whileInView={fadeIn('right', 'tween', 0.2, 1).show}
      ...
      <motion.div
        ...
        initial={fadeIn('left', 'tween', 0.2, 1).hidden}
        whileInView={fadeIn('left', 'tween', 0.2, 1).show}
